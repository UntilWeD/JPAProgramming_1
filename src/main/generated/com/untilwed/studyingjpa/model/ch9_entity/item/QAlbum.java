...
public class QAlbum extends EntityPathBase<Album> {
    ...
    private static final long serialVersionUID = -304863622L;

    public static final QAlbum album = new QAlbum("album");

    public final QItemP9 _super = new QItemP9(this);

    public final StringPath artist = createString("artist");

    //inherited
    public final ListPath<com.untilwed.studyingjpa.model.ch9_entity.CategoryP9, com.untilwed.studyingjpa.model.ch9_entity.QCategoryP9> categories = _super.categories;
